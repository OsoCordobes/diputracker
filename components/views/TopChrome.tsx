    ...
    <>
      ...
      <div style={{ position: "sticky", top: 0, zIndex: 60, background: "rgba(250,250,249,0.86)", backdropFilter: "saturate(140%) blur(10px)", borderBottom: "1px solid #E7E3DB" }}>
        <div style={{ maxWidth: "1180px", margin: "0 auto", padding: "8px 28px", minHeight: "62px", display: "flex", alignItems: "center", flexWrap: "wrap", gap: "8px 24px" }}>
          ...
          <div className="dt-topnavtabs" style={{ display: "flex", gap: "4px", marginLeft: "6px" }}>
          ...
          <div style={{ marginLeft: "auto" }}>
            <button onClick={V.openSearch} className="hov-border dt-searchbtn" style={{ display: "flex", alignItems: "center", gap: "9px", background: "#FFFFFF", border: "1px solid #E0DBD0", borderRadius: "8px", padding: "8px 13px", cursor: "pointer", color: "#8A857A", fontFamily: "inherit", fontSize: "13px", minWidth: 0, textAlign: "left" }}>
