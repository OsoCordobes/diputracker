      ...
      <div style={{ position: "sticky", top: 0, zIndex: 60, background: "rgba(250,250,249,0.86)", backdropFilter: "saturate(140%) blur(10px)", borderBottom: "1px solid #E7E3DB" }}>
        <div style={{ maxWidth: "1180px", margin: "0 auto", padding: "8px 28px", minHeight: "62px", display: "flex", alignItems: "center", flexWrap: "wrap", gap: "8px 24px" }}>
          ...
          <div style={{ display: "flex", gap: "4px", marginLeft: "6px" }}>
            <button onClick={V.goHome} className={V.navHomeBg === "transparent" ? "hov-nav" : undefined} style={{ background: V.navHomeBg, color: V.navHomeFg, border: "none", borderRadius: "7px", padding: "7px 13px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 500, cursor: "pointer", letterSpacing: "0.01em" }}>Panel</button>
            <button onClick={V.goIndices} className={V.navIdxBg === "transparent" ? "hov-nav" : undefined} style={{ background: V.navIdxBg, color: V.navIdxFg, border: "none", borderRadius: "7px", padding: "7px 13px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 500, cursor: "pointer" }}>Índices</button>
            <button onClick={V.goVotacion} className={V.navVotBg === "transparent" ? "hov-nav" : undefined} style={{ background: V.navVotBg, color: V.navVotFg, border: "none", borderRadius: "7px", padding: "7px 13px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 500, cursor: "pointer" }}>Votaciones</button>
            <button onClick={V.goPatrimonio} className={V.navPatBg === "transparent" ? "hov-nav" : undefined} style={{ background: V.navPatBg, color: V.navPatFg, border: "none", borderRadius: "7px", padding: "7px 13px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 500, cursor: "pointer" }}>Patrimonio</button>
            <button onClick={V.goSimulador} className={V.navSimBg === "transparent" ? "hov-nav" : undefined} style={{ background: V.navSimBg, color: V.navSimFg, border: "none", borderRadius: "7px", padding: "7px 13px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 500, cursor: "pointer" }}>Simulador</button>
          </div>
