    ...
    <div className="dt-view">
      ...
      <div style={{ maxWidth: "1180px", margin: "0 auto", padding: "48px 28px 8px" }}>
        ...
        <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginTop: "18px", alignItems: "center" }}>
          ...
          <button onClick={V.perTodo} className="dt-num" style={{ fontSize: "12px", background: V.perTodoBg, color: V.perTodoFg, border: `1px solid ${V.perTodoBorder}`, borderRadius: "20px", padding: "5px 13px", cursor: "pointer", fontFamily: "inherit", transition: "all .2s", whiteSpace: "nowrap" }}>Todo · dic 2025 → may 2026 · {V.perTodoCount}</button>
          <button onClick={V.perExt} className="dt-num" style={{ fontSize: "12px", background: V.perExtBg, color: V.perExtFg, border: `1px solid ${V.perExtBorder}`, borderRadius: "20px", padding: "5px 13px", cursor: "pointer", fontFamily: "inherit", transition: "all .2s", whiteSpace: "nowrap" }}>Extraordinarias · {V.perExtCount}</button>
          <button onClick={V.perOrd} className="dt-num" style={{ fontSize: "12px", background: V.perOrdBg, color: V.perOrdFg, border: `1px solid ${V.perOrdBorder}`, borderRadius: "20px", padding: "5px 13px", cursor: "pointer", fontFamily: "inherit", transition: "all .2s", whiteSpace: "nowrap" }}>Ordinarias 2026 · {V.perOrdCount}</button>
      ...
      <div style={{ maxWidth: "1180px", margin: "0 auto", padding: "26px 28px 0", display: "flex", alignItems: "center", gap: "18px", flexWrap: "wrap" }}>
        <div style={{ display: "inline-flex", background: "#F0EDE6", border: "1px solid #E2DDD2", borderRadius: "10px", padding: "3px" }}>
          <button onClick={V.setIndice} style={{ border: "none", borderRadius: "7px", padding: "8px 15px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 600, cursor: "pointer", background: V.modeIndiceBg, color: V.modeIndiceFg, boxShadow: V.modeIndiceSh, transition: "all .2s" }}>Por índice</button>
          <button onClick={V.setBloque} style={{ border: "none", borderRadius: "7px", padding: "8px 15px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 600, cursor: "pointer", background: V.modeBloqueBg, color: V.modeBloqueFg, boxShadow: V.modeBloqueSh, transition: "all .2s" }}>Por bloque</button>
          <button onClick={V.setInter} style={{ border: "none", borderRadius: "7px", padding: "8px 15px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 600, cursor: "pointer", background: V.modeInterBg, color: V.modeInterFg, boxShadow: V.modeInterSh, transition: "all .2s" }}>Interbloques</button>
          <button onClick={V.setPoder} style={{ border: "none", borderRadius: "7px", padding: "8px 15px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 600, cursor: "pointer", background: V.modePoderBg, color: V.modePoderFg, boxShadow: V.modePoderSh, transition: "all .2s" }}>Poder</button>
          <button onClick={V.setDisidencia} style={{ border: "none", borderRadius: "7px", padding: "8px 15px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 600, cursor: "pointer", background: V.modeDisBg, color: V.modeDisFg, boxShadow: V.modeDisSh, transition: "all .2s" }}>Disidencias</button>
        </div>
