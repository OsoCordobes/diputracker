      ...
      <div className="dt-g3" style={{ maxWidth: "1180px", margin: "0 auto", padding: "30px 28px 12px", display: "grid", gridTemplateColumns: "1.3fr 1fr 1fr", gap: "36px" }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "7px", fontSize: "12.5px" }}>
            <a href="https://www.diputados.gov.ar/diputados/" target="_blank" style={{ textDecoration: "none", borderBottom: "1px solid #EDE7DA", width: "fit-content" }}>Nómina y bloques — HCDN ↗</a>
            <a href="https://votaciones.hcdn.gob.ar" target="_blank" style={{ textDecoration: "none", borderBottom: "1px solid #EDE7DA", width: "fit-content" }}>Actas de votación — HCDN ↗</a>
            <a href="https://datos.hcdn.gob.ar" target="_blank" style={{ textDecoration: "none", borderBottom: "1px solid #EDE7DA", width: "fit-content" }}>Datos abiertos — HCDN ↗</a>
            <a href="https://www2.jus.gov.ar/consultaddjj/Home/Busqueda" target="_blank" style={{ textDecoration: "none", borderBottom: "1px solid #EDE7DA", width: "fit-content" }}>DDJJ — Oficina Anticorrupción ↗</a>
          </div>
        </div>
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "7px", fontSize: "12.5px" }}>
            ...
            <button onClick={V.downloadCsv} style={{ background: "none", border: "none", padding: 0, fontFamily: "inherit", fontSize: "12.5px", color: "#B45309", cursor: "pointer", textAlign: "left", width: "fit-content", fontWeight: 600 }}>{V.csvLabelFooter}</button>
          </div>
        </div>
      </div>
