    ...
    <div className="dt-view" style={{ maxWidth: "1180px", margin: "0 auto", padding: "42px 28px 70px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "16px", flexWrap: "wrap", marginTop: "24px" }}>
        <div style={{ display: "inline-flex", background: "#F0EDE6", border: "1px solid #E2DDD2", borderRadius: "10px", padding: "3px" }}>
          ...
          <button onClick={V.tabRup} aria-pressed={V.tabRupBg !== "transparent"} style={{ border: "none", borderRadius: "7px", padding: "8px 15px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 600, cursor: "pointer", background: V.tabRupBg, color: V.tabRupFg, boxShadow: V.tabRupSh, transition: "all .2s" }}>Disidencias</button>
          <button onClick={V.tabTer} aria-pressed={V.tabTerBg !== "transparent"} style={{ border: "none", borderRadius: "7px", padding: "8px 15px", fontFamily: "inherit", fontSize: "13.5px", fontWeight: 600, cursor: "pointer", background: V.tabTerBg, color: V.tabTerFg, boxShadow: V.tabTerSh, transition: "all .2s" }}>Territorio</button>
        </div>
      </div>
