    ...
    <div className="dt-view" style={{ maxWidth: "1180px", margin: "0 auto", padding: "42px 28px 70px" }}>
      ...
      <div className="dt-g2" style={{ display: "grid", gridTemplateColumns: "1fr 1.15fr", gap: "16px", marginTop: "26px", alignItems: "start" }}>
        <div style={{ background: "#FFFFFF", border: "1px solid #E7E3DB", borderRadius: "14px", padding: "22px 24px" }}>
          ...
          <div style={{ borderTop: "1px solid #F2EFE9", marginTop: "16px", paddingTop: "14px" }}>
            ...
            <a href="https://www.congreso.gob.ar/reglamentoDiputados.pdf" target="_blank" className="dt-num" style={{ display: "inline-block", fontSize: "11px", color: "#B45309", textDecoration: "none", borderBottom: "1px solid #F0D9B8", marginTop: "8px" }}>Reglamento HCDN — arts. 17–20 ↗</a>
          </div>
          <a href={V.patDietaU} target="_blank" className="dt-num" style={{ display: "inline-block", fontSize: "11px", color: "#B45309", textDecoration: "none", borderBottom: "1px solid #F0D9B8", marginTop: "14px" }}>{V.patDietaFuente} · {V.patDietaFecha} ↗</a>
        </div>
      ...
      <div style={{ background: "#FFFFFF", border: "1px solid #E7E3DB", borderRadius: "14px", padding: "22px 24px", marginTop: "16px" }}>
        ...
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", marginTop: "18px" }}>
          <a href="https://www2.jus.gov.ar/consultaddjj/Home/Busqueda" target="_blank" style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "#1C1A17", color: "#FAFAF9", borderRadius: "10px", padding: "11px 18px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>Buscador de DDJJ — OA ↗</a>
          <a href="https://www2.hcdn.gob.ar/institucional/infGestion/declaraciones_juradas/index.html" target="_blank" style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "#FFFFFF", color: "#1C1A17", border: "1px solid #E0DBD0", borderRadius: "10px", padding: "11px 18px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>Presentaciones en la HCDN ↗</a>
          <a href="https://www.argentina.gob.ar/servicio/consultar-declaraciones-juradas-de-funcionarios-publicos" target="_blank" style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "#FFFFFF", color: "#1C1A17", border: "1px solid #E0DBD0", borderRadius: "10px", padding: "11px 18px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>Guía oficial del trámite ↗</a>
        </div>
