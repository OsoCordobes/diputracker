    ...
    <div className="dt-view" style={{ maxWidth: "1180px", margin: "0 auto", padding: "42px 28px 70px" }}>
      ...
      <div style={{ background: "#FFFFFF", border: "1px solid #E7E3DB", borderRadius: "14px", padding: "22px 24px", marginTop: "16px" }}>
        ...
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", marginTop: "18px" }}>
          ...
          <a href="https://www2.hcdn.gob.ar/institucional/infGestion/declaraciones_juradas/index.html" target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "#FFFFFF", color: "#1C1A17", border: "1px solid #E0DBD0", borderRadius: "10px", padding: "11px 18px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>Presentaciones en la HCDN ↗</a>
